 ...
 * 4. expands screen to 5 and 10 to real play, was only buttons
 * ПЛЮСЫ: 3 вида поля,
 * МИНУСЫ: сообщения надо не в методах, а в константах, слишком простой AI, при выходе нет подтвержденияб и также см. пп 1 - 4,
