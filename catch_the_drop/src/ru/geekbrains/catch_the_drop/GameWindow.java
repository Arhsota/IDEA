/**
 * Home work from Java quick start. The game "Catch the drop"
 * @author Andrey Sevasstyanov
 * @version 0.1 dated October 1,2016
 *
 *
*/
...
public class GameWindow extends JFrame{
    ...
    public static void main(String[] args) throws IOException {
        ...
        game_window.add(jpBottom, BorderLayout.SOUTH);
